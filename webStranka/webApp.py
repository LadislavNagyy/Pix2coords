...
# funkcia sluzi na vytvorenjie priečinka /static/uploads, ak este neexistuje.
...
# inicializacia globalnych premennychz mainScript.py
globalne_premenne()
...
@webApp.route('/upload', methods=['GET', 'POST'])  # Opravená route
def upload_page():
